...
Enable Currency
    ...
    Wait Until Element Is Visible    css=a.nav-link.currencies    10s
    Click Element    css=a.nav-link.currencies 
    Wait Until Element Is Visible    css=input#checkbox-3.form-check-input    10s
    Click Element                    css=input#checkbox-3.form-check-input
    ...
    Pass Execution                   Currency successfully enabled.
...
Disable Currency
    ...
    Pass Execution                   Currency successfully disabled.